...
```sh
go get github.com/Sunoo/go-rpi-rgb-led-matrix
```
...
```sh
cd $GOPATH/src/github.com/Sunoo/go-rpi-rgb-led-matrix/vendor/rpi-rgb-led-matrix/
git submodule update --init
make
cd $GOPATH/src/github.com/Sunoo/go-rpi-rgb-led-matrix/
go install -v ./...
```
...
Check the folder [`examples`](https://github.com/Sunoo/go-rpi-rgb-led-matrix/tree/master/examples) folder for more examples
